...
let rec insert0_all_lt (x:int) (t:bst0) (y:int)
  ...
  | N (l, z, r) ->
    if x = z then ()
    else if x < z then insert0_all_lt x l y
...
let rec insert0_all_gt (x:int) (t:bst0) (y:int)
  ...
  | N (l, z, r) ->
    if x = z then ()
    else if x < z then insert0_all_gt x l y
...
let rec insert0_bst (x:int) (t:bst0) : Lemma (requires is_bst t) (ensures is_bst (insert0 x t)) =
  ...
  | N (l, z, r) ->
    if x = z then ()
      ...
      insert0_all_lt x l z;
      insert0_bst x l
    ) else (
      insert0_all_gt x r z;
      insert0_bst x r
    )
